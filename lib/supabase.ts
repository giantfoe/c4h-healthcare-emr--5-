...
const comprehensivePatients: Patient[] = [
  // Pregnant Women - Various stages and risk levels
  {
    ...
    last_menstrual_period: "2023-07-20",
    risk_level: "low",
  ...
  },
  {
    ...
    medical_history: "Previous normal delivery",
    current_medications: "Folic acid, Prenatal vitamins",
    blood_type: "A+",
...
const comprehensiveAppointments: Appointment[] = [
  ...
  },
  {
    ...
    priority: "normal",
    duration: 30,
    notes: "Breastfeeding assessment and child growth monitoring",
  },
  {
    id: "3",
    created_at: "2024-01-03T00:00:00Z",
    ...
    priority: "urgent",
    duration: 60,
    notes: "Blood pressure monitoring, diabetes management",
  },
  {
    id: "4",
    created_at: "2024-01-04T00:00:00Z",
    ...
    type: "Twin Pregnancy Check",
    status: "pending",
    priority: "normal",
    duration: 60,
    notes: "Ultrasound and growth monitoring for twins",
  },
  {
    id: "5",
    created_at: "2024-01-05T00:00:00Z",
    ...
    priority: "normal",
    duration: 30,
    notes: "Mixed feeding counseling and weight check",
  },
  {
    id: "6",
    created_at: "2024-01-06T00:00:00Z",
  ...
  // Today's appointments
  {
    ...
    priority: "urgent",
    duration: 60,
    notes: "Blood pressure check, fetal monitoring",
  },
  {
    id: "12",
    created_at: "2024-01-12T00:00:00Z",
...
export const patientService = {
  async getAll(): Promise<Patient[]> {
    if (!isSupabaseConfigured || !supabase) {
      return Promise.resolve(comprehensivePatients)
    }
...
export const appointmentService = {
  async getAll(): Promise<Appointment[]> {
    if (!isSupabaseConfigured || !supabase) {
      ...
      return Promise.resolve(appointmentsWithPatients)
    }
